...
const AsignarBaston = () => {
    ...
    useEffect(() => {
        const fetchUsuarios = async () => {
            try {
                const response = await axios.get("https://ec2-18-224-58-2.us-east-2.compute.amazonaws.com/usuario/obtener", {
                    headers: {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            await axios.post("https://ec2-18-224-58-2.us-east-2.compute.amazonaws.com/bastones/asignar_baston", data, {
                headers: {
